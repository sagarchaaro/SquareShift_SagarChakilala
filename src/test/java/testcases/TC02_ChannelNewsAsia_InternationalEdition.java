...
public class TC02_ChannelNewsAsia_InternationalEdition {
	static WebDriver driver;
	public static final String element_headline_title="(//div[@class='list-object list-object--']/h3/a[contains(@class,'list-object__heading-link')])[1]";
	public static final String element_Second_ReadFullStory="(//a[contains(text(),'Expand to read the full story')])[2]";
	public static final String element_SingaPore_category="//h2[text()='Main navigation']/..//a[text()='Singapore']";
	...
	public void test_channelNewsAsia() throws Exception{
		...
		driver.findElement(By.xpath(element_SingaPore_category)).click();
		Log.info("Singapore category is clicked");
		...
		Assert.assertTrue(articleTitle.contains(Constants.expectedArticleTitle_SingaporeEdition));
